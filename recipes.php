   	  	...
   	  	<div class="span12">
   	  		<div class="well">
					...
					<div class="input-prepend" style="float: right">
						...
						</span><input id="filter-recipes" type="text" class="span3 tip" rel="tooltip" data-placement="top" data-original-title="By id, name or interpreter." maxlength="100" placeholder="Filter Recipes…" value=""<?php echo (count($recipes) === 0) ? ' disabled="disabled"' : null ?> />
					</div>
				</div>
				<div class="clear"></div>
   	  		</div>
