    		...
    		<div class="well">
				...
				<form id="form-settings" class="well form-horizontal" method="post" action="/actions/edit_settings.php">
			    	 ...
			    	 <fieldset>
				    	...
				    	<div class="control-group" id="settings-public-ssh-key"><div class="progress progress-striped active"><div class="bar" style="width: 100%;"></div></div></div>
				     </fieldset>
			    	 <fieldset>
				     ...
				     <fieldset>
				        ...
				        <div class="control-group">
				        	...
				        	<div class="controls">
				        		<select name="timezone_offset" id="timezone-offset" class="span5" data-placeholder="" data-value="<?php echo isset($settings->data->timezone_offset) ? $settings->data->timezone_offset : "+00:00" ?>">
